...
//       const res = await fetch("http://localhost:5000/api/oauth/google-signup", {
//         method: "POST",
...
//               <select
//                 {...register("gender")}
//                 className="border rounded w-full p-2 mt-1 text-gray-700 focus:ring focus:ring-blue-200"
//               >
